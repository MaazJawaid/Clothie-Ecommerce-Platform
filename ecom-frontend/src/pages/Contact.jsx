    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>12345 Elm Street <br /> Suite 210, San Francisco, CA, USA</p>
          <p className=' text-gray-500'>Tel: (415) 555-0132 <br /> Email: admin@clothie.com</p>
          <p className='font-semibold text-xl text-gray-600'>Join Our Team</p>
          <p className='text-gray-500'>Discover exciting career opportunities with us and be part of our growing family.</p>
